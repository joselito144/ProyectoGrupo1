...
class NeighborhoodControllers {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const neighborhoods = yield database_1.default.query('SELECT barrio, count(*) as cantidad FROM unidades group by barrio');
...
exports.default = neighborhoodControllers;
